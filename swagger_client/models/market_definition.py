...
class MarketDefinition(object):
    ...
    def __init__(self):
        ...
        self._timezone = None
        self._each_way_divisor = None
        self._regulators = None
        self._market_type = None
        self._market_base_rate = None
        self._number_of_winners = None
        self._country_code = None
        self._in_play = None
        self._bet_delay = None
        self._bsp_market = None
        self._betting_type = None
        self._number_of_active_runners = None
        self._event_id = None
        self._cross_matching = None
        self._runners_voidable = None
        self._turn_in_play_enabled = None
        self._suspend_time = None
        self._discount_allowed = None
    ...
    def betting_type(self, betting_type):
        ...
        if betting_type not in allowed_values:
            raise ValueError(
                "Invalid value for `betting_type`, must be one of {0}"
